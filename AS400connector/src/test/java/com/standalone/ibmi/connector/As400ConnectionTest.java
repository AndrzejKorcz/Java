...
public class As400ConnectionTest {
    ...
    @Test
    public void as400ConnectionAutoCloseable() {
        try(As400Connection as400ConnectionAutoCloseable = new As400Connection("hostName", "UserId", "secret")) {
            assertNotNull(as400ConnectionAutoCloseable);
        };
    }
